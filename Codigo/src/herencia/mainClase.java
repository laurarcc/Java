...
public class mainClase {
    public static void main(String[] args){
        ...
        ArrayList<profesores> listP=new ArrayList<>();
        ...
        if(var.equalsIgnoreCase("PROFESORES")){
            ...
            do{
                ...
                Datos variables = getDatos(teclado);

                String NRP = teclado.next();
                String espcialidad =teclado.next();
                String CentroDestino=teclado.next();

                profesores teacher =new profesores(variables.name(), variables.DNI(), variables.fecha_nac(),NRP,espcialidad,CentroDestino);
                listP.add(teacher);
            ...
            do{
                ...
                alumnos estudiante = new alumnos(variables.name(), variables.DNI(),variables.fecha_nac(),CIAL,ciclo);
    ...
    private static Datos getDatos(Scanner teclado) {
        String name= teclado.next();
        String DNI= teclado.next();
        LocalDate fecha_nac= LocalDate.parse(teclado.next());
        return new Datos(name, DNI, fecha_nac);
    }
